...
function ContactMe() {
  return (
    <section className="main-section" id="contact" style={{ height: "90vh" }}>
      <p className="text-2">
        You can reach out to me via one of the following:
      </p>
      <br />
      <table>
        <tr>
          <td className="p-1">
            <a
              className="profile-link btn contact-btn contactButton"
        ...
        <tr>
          <td className="p-1">
            <a
              className="btn contact-btn contactButton"
              href="tel:+61404831362"
            >
              📱
            </a>
          </td>
